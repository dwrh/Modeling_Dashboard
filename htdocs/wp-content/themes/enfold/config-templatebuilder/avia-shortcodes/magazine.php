...
if ( !class_exists( 'avia_magazine' ) )
{
	class avia_magazine
	{
		...
		function render_entry($entry, $style)
		{
			...
			$markupEntry  	= avia_markup_helper(array('context' => 'entry','echo'=>false));
			$markupTitle 	= avia_markup_helper(array('context' => 'entry_title','echo'=>false));
			$markupContent 	= avia_markup_helper(array('context' => 'entry_content','echo'=>false));
			$markupTime 	= avia_markup_helper(array('context' => 'entry_time','echo'=>false));
