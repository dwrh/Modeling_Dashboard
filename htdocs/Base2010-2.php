...
<body>
    ...
    <div id="content-area">
        ...
        <tr>
            <td>
                <?php
                echo renderChart("FusionCharts/MSBar3D.swf", "", $strXML_b11, "B11", 600, 300, false, true);
                ?>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <?php
                echo renderChart("FusionCharts/StackedBar3D.swf", "", $strXML_b12, "B12", 600, 300, false, true);
                ?>
            </td>
        </tr>
