...
if ( !class_exists( 'aviaccordion' ) )
{
	class aviaccordion
	{
		...
		function html()
		{
			...
			$output .= "<div class='aviaccordion {$overlay_class}' style='max-height:".$this->config['max-height']."px' {$data} >";
			...
			foreach($this->slides as $key => $slide)
			{
				...
				$output .= "<li class='aviaccordion-slide aviaccordion-slide-{$counter}' {$style} {$data}>";
				...
				if($this->config['title'] !== "inactive" && (!empty($slide->post_title) || !empty($slide->post_excerpt)))
				{
					...
					$output .= !empty($slide->post_title) ? "<div class='aviaccordion-title'>".$slide->post_title."</div>" : "";
					$output .= !empty($slide->post_excerpt) && !empty($this->config['excerpt']) ? "<div class='aviaccordion-excerpt'>".wpautop($slide->post_excerpt)."</div>" : "";
					$output .= "</div></div></div>";
				}
				$output .= "</div>";
