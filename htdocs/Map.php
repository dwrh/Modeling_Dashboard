...
<td>
	...
	<table class="main_table" cellspacing="0" cellpadding="1" width="1000">
	<tr>
	<td>
...
//	   var map = new FusionCharts("../FusionMaps_XT_Website/Maps/FCMap_<?=$MAP?>.swf", "MapId", "980", "820", "0", "0");
	   var map = new FusionCharts("FusionCharts/FCMap_<?=$MAP?>.swf", "MapId", "980", "820", "0", "0");
//		myMap.setXMLData(strXML);
