...
*  Standard SAM accounts
   ...
   natrs          "Natural resource remuneration"
   hhsld          "Household"
   gov            "Government"
   inv            "Investment"
   depry          "Depreciation"
   trdmg          "Trade margins"
   indtx          "Indirect tax"
   prdtx          "Production tax"
   imptx          "Import tax"
   exptx          "Export tax"
   fcttx          "Taxes on factors of production"
   fctts          "Subsidies on factors of production"
   dirtx          "Direct taxation"
   bank           "Banking sector"
