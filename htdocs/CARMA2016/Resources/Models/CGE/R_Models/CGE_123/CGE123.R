  # Install the package "nleqslv" for solving systems of non linear equations:
	...
	library(nleqslv) # you have to load the package with the library() function after every time you open R
        ...
        # This file presents an R-based implementation of the 123 CGE model
         ...
         # Last Modification: David Roland-Holst, September 2011
...
# Initialization of parameters
      ...
      # Store these initial values as the benchmark:
      
      par_bench = c(PWm,PWe,tm,te,ts,ty,tr,ft,re,sr,X,G,B,OMEGA,sigma,at,aq,bq,bt,rt,rq)
      names(par_bench) = c("PWm","PWe","tm","te","ts","ty","tr","ft","re","sr","X","G","B","OMEGA","sigma","at","aq","bq","bt","rt","rq")
...
# Create an empty vector which we will fill with all of our equations
...
# Nominal flows
 ...
 # Price equations
           # [10]    internal import prices
           # [11]    internal export prices
           # [12]    consumer prices
           # [13]    national product price index
           # [14]    producer prices for the composite good
 ...
 # Market clearing Equations
           # [16]    domestic good excess demand
           # [17]    Armington composite excess demand
           # [18]    capital and current account relationship
           # [19]    savings investment linkage
...
# [4]	Solve the model
		...
		model_solution_bench=nleqslv(x=initial_vals,fn=f)

# [5]	Store, label, and print the solution:

		solution_values_bench=model_solution_bench$x

		names(solution_values_bench)=c("E","M","Ds","Dd","Qs","Qd","Pe","Pm","Pd","Pt","Px","Pq","t","R","Sg","Y","C","S","Z","ts")

		print(solution_values_bench)
...
# SCENARIO 1:    Here we implement a foreign capital inflow experiment by increasing foreign remittances tenfold.

						re = 10*re ;

# Solve the model again:
		
		model_solution_scen1= nleqslv(x=initial_vals,fn=f)
		
		solution_values_scen1=model_solution_scen1$x

		names(solution_values_scen1)=c("E","M","Ds","Dd","Qs","Qd","Pe","Pm","Pd","Pt","Px","Pq","t","R","Sg","Y","C","S","Z","ts")
		
		solution_perc_scen1=(solution_values_scen1-solution_values_bench)/solution_values_bench

		names(solution_perc_scen1)=c("E","M","Ds","Dd","Qs","Qd","Pe","Pm","Pd","Pt","Px","Pq","t","R","Sg","Y","C","S","Z","ts")

		solution_scen1=rbind(solution_values_scen1,solution_perc_scen1)
		rownames(solution_scen1)=c("Scenario1_Values","Scenario1_Percent_Change")
		
		print(solution_scen1)




# SCENARIO 2:     In this next conduct an adverse terms-of-trade experiment by reducing export prices 20 percent.
...
# Solve the model again:
		...
		model_solution_scen2= nleqslv(x=initial_vals,fn=f)
		
		solution_values_scen2=model_solution_scen2$x

		names(solution_values_scen2)=c("E","M","Ds","Dd","Qs","Qd","Pe","Pm","Pd","Pt","Px","Pq","t","R","Sg","Y","C","S","Z","ts")

		solution_perc_scen2=(solution_values_scen2-solution_values_bench)/solution_values_bench

		names(solution_perc_scen2)=c("E","M","Ds","Dd","Qs","Qd","Pe","Pm","Pd","Pt","Px","Pq","t","R","Sg","Y","C","S","Z","ts")

		solution_scen2=rbind(solution_values_scen2,solution_perc_scen2)
		rownames(solution_scen2)=c("Scenario2_Values","Scenario2_Percent_Change")
		
		print(solution_scen2)



# Displaying all results:

		solution_all=rbind(solution_values_bench,solution_scen1,solution_scen2)
		rownames(solution_all)[1]="Benchmark_Values"
		print(solution_all)
