...
*
*  Remove tariffs in a phaseout
*
* --------------------------------------------------------------------

$Title TAR

set sim  Simulation title / TAR / ;
...
file wtfcsv        / 'WTFTAR.csv' /
scalar ifWTF       / 1 / ;
scalar ifWTFhdr    / 1 / ;

file samcsv        / 'SAMTAR.csv' /
scalar ifSAM       / 1 / ;
scalar ifSAMhdr    / 1 / ;
...
sets
   t     time horizon     / Base, tar75, tar50, tar25, tar0 /
   tt(t) solution periods / tar75, tar50, tar25, tar0 /
   t0(t) base period      / Base /
   tr(t) reporting years  / Base, tar75, tar50, tar25, tar0 /
   ;
...
* ----- Define the shocks
      ...
      tar.fx(r,rp,i) = work*tar0(r,rp,i) ;
