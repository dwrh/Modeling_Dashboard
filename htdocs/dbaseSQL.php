...
$dsn = "mysql:host=localhost;dbname=CSV_DB;charset=utf8";
...
try {
    $pdo = new PDO($dsn,'root','krupuk', $opt);
    $pdo->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $query = $pdo->prepare(" SELECT * FROM `tbl_name` WHERE `COL 1` = :AID ");
...
<!--
	<li class="menuparent"><a class="menuparent" href="dbregister.php?cty=<?=$AID?>">Registration</a>
	<li class="menuparent"><a class="menuparent" href="dbevent.php?cty=<?=$AID?>">Event</a>
	<li class="menuparent"><a class="menuparent" href="dbscan.php?cty=<?=$AID?>">Scan</a>
-->
